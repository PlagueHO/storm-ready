...
export const SCENARIOS: readonly Scenario[] = [
  {
    ...
    tagline: 'Rising water is on its way. Protect what matters most.',
    emoji: '🌊',
    durationSeconds: 45,
    tasks: [
      {
      ...
      {
        id: 'flood-kit',
        label: 'Grab the emergency kit',
        description: 'Torch, water, first-aid and a charged power bank.',
        category: 'supplies',
        points: 20,
      },
      {
        id: 'flood-plan',
        label: 'Agree an evacuation plan',
        description: 'Know your route and meeting point before you need it.',
        category: 'people',
        points: 20,
      },
    ],
